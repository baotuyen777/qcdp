	...
	function widget($args, $instance) {
		...
		$instance = wp_parse_args( (array)$instance, array(
            ...
            <div id="supporter-info">
                <img class="image_support" src="<?php echo get_stylesheet_directory_uri() ?>/images/bg-support.png">
			<?php
            ...
            ?>
				...
				<div class="online">
					...
					<?php if(!empty($instance['supporter_'.$i.'_skype'])) : ?><p class="skype"><a href="<?php echo 'skype:'.$instance['supporter_'.$i.'_skype'].'?chat'; ?>"><img src="<?php echo $url.'/images/icon-skype.png' ?>" style="border: none; width:auto; height: 24px;" width="100" height="24" alt="My status" /></a></p><?php endif; ?>
				</div>
